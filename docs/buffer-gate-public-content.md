...
For a detailed example, see [How to consume and maintain public content with Azure Container Registry Tasks](./container-registry-consuming-public-content.md).
